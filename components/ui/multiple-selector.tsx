...
interface MultipleSelectorProps {
  ...
  /** Inverted style: black border, text, placeholder */
  inverted?: boolean;
}
  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'ring-offset-background focus-within:ring-ring flex items-start justify-between rounded-md px-3 py-2 text-base focus-within:ring-2 md:text-sm',
            inverted
